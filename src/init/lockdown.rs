...
use crate::{Activity, InfoPerMSOA, Population, CTY20, MSOA};

/// The result is in [0, 1]
pub fn calculate_lockdown_per_day(
    msoas_per_google_mobility: BTreeMap<CTY20, Vec<MSOA>>,
    info_per_msoa: &BTreeMap<MSOA, InfoPerMSOA>,
    ...
    let total_population: f64 = population_per_google_mobility.values().sum::<usize>() as f64;
