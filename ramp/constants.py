...
class Constants:
    ...
    class Paths:
        ...
        class DATA:
            FOLDER = data_folder
            FULL_PATH_FOLDER = os.path.join(abspath, FOLDER)

        # --> DATA
        class RAW_DATA:
            FOLDER = raw_data_folder
            FULL_PATH_FOLDER = os.path.join(abspath, data_folder, FOLDER)

        # -->--> RAW_DATA
        class REFERENCE_DATA:
            FOLDER = reference_data_folder
            FULL_PATH_FOLDER = os.path.join(
                abspath, data_folder, raw_data_folder, FOLDER
            )
        ...
        class LUT:
            ...
            FULL_PATH_FILE = os.path.join(
                abspath, data_folder, raw_data_folder, reference_data_folder, FILE
            )
        ...
        class TIME_AT_HOME:
            ...
            FULL_PATH_FILE = os.path.join(
                abspath, data_folder, raw_data_folder, national_data_folder, FILE
            )
        ...
        class QUANT:
            ...
            FULL_PATH_FOLDER = os.path.join(
                abspath, data_folder, raw_data_folder, national_data_folder, FOLDER
            )
        ...
        class OSM_FOLDER:
            FOLDER = "OSM"
            FULL_PATH_FOLDER = os.path.join(
                abspath, data_folder, raw_data_folder, county_data_folder, FOLDER
            )
        ...
        class TU:
            FILE = "tus_hse_"
            FULL_PATH_FILE = os.path.join(
                abspath, data_folder, raw_data_folder, county_data_folder, FILE
            )
        ...
        class SNAPSHOTS:
            FOLDER = "snapshot"
            FULL_PATH_FOLDER = os.path.join(
                abspath, data_folder, processed_data_folder, FOLDER
            )
        ...
        class INITIALISATION:
            ...
            FULL_PATH_FOLDER = os.path.join(abspath, code_folder, FOLDER)

        # <--<-- INITIALISE
        # -->--> MODEL
        class MODEL:
            FULL_PATH_FOLDER = os.path.join(abspath, code_folder)
        ...
        class OPENCL_FONTS:
            ...
            FULL_PATH_DROID = os.path.join(abspath, code_folder, FOLDER, FONT_DROID)
            FONT_ROBOTO = "RobotoMono.ttf"
            FULL_PATH_ROBOTO = os.path.join(abspath, code_folder, FOLDER, FONT_ROBOTO)

        class OPENCL_SOURCE:
            FULL_PATH_SOURCE = os.path.join(abspath, code_folder)
            KERNELS_FOLDER = opencl_kernels_folder
            FULL_PATH_KERNEL_FOLDER = os.path.join(abspath, code_folder, KERNELS_FOLDER)
            # **** IMPORTANT ****
            ...
            FOLDER_PATH_FOR_KERNEL = os.path.join(code_folder, KERNELS_FOLDER)
            KERNEL_FILE = "ramp_ua.cl"
            FULL_PATH_KERNEL_FILE = os.path.join(
                abspath, code_folder, KERNELS_FOLDER, KERNEL_FILE
            )
            # **** END ****
            SHADERS_FOLDER = opencl_shaders_folder
            FULL_PATH_SHADERS_FOLDER = os.path.join(
                abspath, code_folder, SHADERS_FOLDER
            )
...
class ColumnNames:
    ...
    INDIVIDUAL_ETH = (
        "DC2101EW_C_ETHPUK11"  # Ethnicity column in the table of individuals
    )
    ...
    CURRENT_RISK = (
        "current_risk"  # This is the risk that people get when visiting locations.
    )
