...
The <i>R</i> code to compute this file is [here](https://github.com/alan-turing-institute/uatk-spc/blob/main/scripts/data_prep/createWorkplaceFile.R).
...
The <i>R</i> code to process these data is [here](https://github.com/alan-turing-institute/uatk-spc/blob/main/scripts/data_prep/createMobilityFile.R).
