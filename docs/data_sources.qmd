...
The fields currently contained are detailed [here](https://ramp0storage.blob.core.windows.net/referencedata/pop_Definitions.txt). They are:
...
Contains three GIS datasets of GB in GeoJson format taken from [ONS boundaries](https://geoportal.statistics.gov.uk/):
