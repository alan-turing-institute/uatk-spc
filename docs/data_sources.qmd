...
- `bmiNew` is a float estimated value for the BMI of the individual. THis were drawn directly according to age, sex and ethnicity and are completely independent of the above values (see [modelling methods](https://alan-turing-institute.github.io/uatk-spc/modelling_methods.html)).
