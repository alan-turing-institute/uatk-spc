...
- A [step by step description](understanding_technical_overview.qmd) of each elemtent of the SPC pipeline
...
Note that due to the large impact each section has on the choices made in other sections, it may be necessary to frequently segway between sections to get a precise understanding of the model.