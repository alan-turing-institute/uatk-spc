...
- [hampshire](https://ramp0storage.blob.core.windows.net/spc-output/v1/hampshire.pb.gz) (Southhampton)
...
- [merseyside](https://ramp0storage.blob.core.windows.net/spc-output/v1/merseyside.pb.gz) (Liverpool)
...
- [tyne_and_wear](https://ramp0storage.blob.core.windows.net/spc-output/v1/tyne_and_wear.pb.gz) (Newcastle)
- [warwickshire](https://ramp0storage.blob.core.windows.net/spc-output/v1/warwickshire.pb.gz)
- [west_midlands](https://ramp0storage.blob.core.windows.net/spc-output/v1/west_midlands.pb.gz) (Birmingham)
- [west_sussex](https://ramp0storage.blob.core.windows.net/spc-output/v1/west_sussex.pb.gz)
- [west_yorkshire](https://ramp0storage.blob.core.windows.net/spc-output/v1/west_yorkshire.pb.gz) (Leeds)
...
- [northwest_transpennine](https://ramp0storage.blob.core.windows.net/spc-output/v1/northwest_transpennine.pb.gz) (Liverpool, Manchester, Leeds)
- [oxford_cambridge_arc](https://ramp0storage.blob.core.windows.net/spc-output/v1/oxford_cambridge_arc.pb.gz) (Oxford, Milton Keynes, Cambridge)
