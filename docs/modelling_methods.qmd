...
The pearson correlations for mean and median between the modelled and raw values are and and .
...
The pearson correlations for mean and median between the modelled and raw values are and .
