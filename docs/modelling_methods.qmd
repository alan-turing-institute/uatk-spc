...
The principles behind the generation of the enriched [SPENSER](https://github.com/nismod/microsimulation) population data and behind the modelling of trips to schools and retail from [QUANT](https://github.com/maptube/QUANT_RAMP) are detailed in
