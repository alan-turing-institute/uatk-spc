...
The <i>R</i> codes for this modelling are [here](https://github.com/alan-turing-institute/uatk-spc/blob/main/scripts/data_prep/incomeModelling.R).
...
| Variable   | Nat All | Nat FT | Nat PT | Nat Male | Nat Male FT | Nat Male PT | Nat Female | Nat Female FT | Nat Female PT |
|------------|---------|--------|--------|----------|-------------|-------------|------------|---------------|---------------|
