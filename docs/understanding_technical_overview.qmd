...
- **Phase 2 - The user has selected a study area and started a simulation**
    ...
    3. Individuals are assigned a single workplace destination (if above 16 y.o), according to the method described [here](https://alan-turing-institute.github.io/uatk-spc/modelling_methods.html#commuting-flows).
...
This join is not spatially differentiated and other potential matching criteria (such as ethnicity and nssec8) were not retained due to a lack of representativity for some groupds inside the survey. The BMI field is then added l. 74-89, according to [this method](https://alan-turing-institute.github.io/uatk-spc/modelling_methods.html#bmi-estimation).
