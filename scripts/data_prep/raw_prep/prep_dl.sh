...
# Unzip
OUTPATH=Data/dl/
unzip -o Data/dl/zip/8860tab_9C6B5888A6C880F95FC0F04CDED028191F4F1F3F865253D46D1EA277830A7D54_V1.zip -d $OUTPATH
unzip -o Data/dl/zip/8090tab_2038dabc18ee4cb41ba5d23972c3bf56.zip -d $OUTPATH
unzip -o Data/dl/zip/8737tab_249939DDF6432AA9A2ED89CECED2F92E_V1.zip -d $OUTPATH
unzip -o Data/dl/zip/8128tab_A34C0A6B082B45E8CAE4D1795D786CEEBF43FD6766C98E10DD13D81B2F586CE4_V1.zip -d $OUTPATH
